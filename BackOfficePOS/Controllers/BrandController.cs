...
namespace BackOfficePOS.Controllers
{
    ...
    public class BrandController : BaseApiController
    {
        ...
        [HttpPost("Brands")]
        public async Task<ActionResult<Pagination<BrandDto>>> GetProductBrands([FromQuery] BrandSpecParams brandSpecParams)
        {
        ...
        [HttpGet("AllBrands")]
        public async Task<ActionResult<BrandDto>> GetAllCategories()
        {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<BrandDto>> GetProductCategorybyID(int id)
        {
